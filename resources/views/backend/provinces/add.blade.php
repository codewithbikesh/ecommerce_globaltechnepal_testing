...
@section('content')
      ...
      <section class="section register min-vh-80 d-flex flex-column align-items-center justify-content-center py-4">
        <div class="container">
          ...
          <div class="card mb-6">
            <div class="card-body">
              <h5 class="card-title"><center>Add Province</center></h5>
                    
                    
              <!-- Multi Columns Form -->
              <form class="row g-3" method="post" action="{{ route('backend.provinces.store') }}" enctype="multipart/form-data">
              @csrf
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-success">Add Province Details</button>
