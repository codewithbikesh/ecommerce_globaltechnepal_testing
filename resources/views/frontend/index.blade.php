                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item {{ $product->category_id }}">
                            <div class="product-o product-o--hover-on product-o--radius">
                                ...
                                <span class="product-o__name">
                                    ...
                                    <a href="{{ route('frontend.product-detail') }}">{{ $product->product_name }}</a></span>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
                                <div class="product-o product-o--hover-on u-h-100">
                                    ...
                                    <span class="product-o__name">
                                        ...
                                        <a href="{{ route('frontend.product-detail') }}">Tablet 13inch Screen Ram 16GB</a></span>
                                    <div class="product-o__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
                                <div class="product-o product-o--hover-on u-h-100">
                                    ...
                                    <span class="product-o__name">
                                        ...
                                        <a href="{{ route('frontend.product-detail') }}">Tablet 12inch Screen Ram 16GB</a></span>
                                    <div class="product-o__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                                        ...
                                        <li class="column-product__item">
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="{{ route('frontend.product-detail') }}">
                                                ...
                                                <div class="product-l__info-wrap">
                                                    ...
                                                    <span class="product-l__name">
                                                        ...
                                                        <a href="{{ route('frontend.product-detail') }}">Razor Gear 15 Ram 16GB</a></span>
                                            ...
                                            <div class="product-l">
                                                ...
                                                <div class="product-l__info-wrap">
                                                    ...
                                                    <span class="product-l__name">
                                                        ...
                                                        <a href="{{ route('frontend.product-detail') }}">Razor Gear 13 Ram 16GB</a></span>
                                            ...
                                            <div class="product-l">
                                                ...
                                                <div class="product-l__info-wrap">
                                                    ...
                                                    <span class="product-l__name">
                                                        ...
                                                        <a href="{{ route('frontend.product-detail') }}">Razor Gear 15 Ram 8GB</a></span>
                                            ...
                                            <div class="product-l">
                                                ...
                                                <div class="product-l__info-wrap">
                                                    ...
                                                    <span class="product-l__name">
                                                        ...
                                                        <a href="{{ route('frontend.product-detail') }}">Razor Gear 10 Ram 16GB</a></span>
                                            ...
                                            <div class="product-l">
                                                ...
                                                <div class="product-l__info-wrap">
                                                    ...
                                                    <span class="product-l__name">
                                                        ...
                                                        <a href="{{ route('frontend.product-detail') }}">Razor Gear 15 Ultra Ram 16GB</a></span>
                                            ...
                                            <div class="product-l">
                                                ...
                                                <div class="product-l__info-wrap">
                                                    ...
                                                    <span class="product-l__name">
                                                        ...
                                                        <a href="{{ route('frontend.product-detail') }}">Razor Gear 20 Ultra Ram 16GB</a></span>
                                            ...
                                            <div class="product-l">
                                                ...
                                                <div class="product-l__info-wrap">
                                                    ...
                                                    <span class="product-l__name">
                                                        ...
                                                        <a href="{{ route('frontend.product-detail') }}">Razor Gear 11 Ultra Ram 16GB</a></span>
                                            ...
                                            <div class="product-l">
                                                ...
                                                <div class="product-l__info-wrap">
                                                    ...
                                                    <span class="product-l__name">
                                                        ...
                                                        <a href="{{ route('frontend.product-detail') }}">Razor Gear 10 Ultra Ram 16GB</a></span>
