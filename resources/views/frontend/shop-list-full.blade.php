...
<!--====== App Content ======-->
    <div class="app-content">
                                        ...
                                        <div class="product-m">
                                            <div class="product-m__thumb">
                                                ...
                                                <div class="product-m__quick-look">
                                                    ...
                                                    <a class="fas fa-search" data-modal="modal" data-modal-id="#quick-look{{ $shoplistproduct->product_code }}" value="{{ $shoplistproduct->product_code }}"
                                                        data-tooltip="tooltip" data-placement="top" title="Quick Look"></a>
                                                </div>
                                                <div class="product-m__add-cart">
    
                                                    <a class="btn--e-brand" data-modal="modal"
                                                        data-modal-id="#add-to-cart{{ $shoplistproduct->product_code }}" value="{{ $shoplistproduct->product_code }}">Add to Cart</a>
                                                </div>
                                            </div>
                                            <div class="product-m__content">
                                                <div class="product-m__category">
    
                                                    <a href="shop-side-version-2.html">{{ $shoplistproduct->category_id }}</a>
                                                </div>
                                                ...
                                                <div class="col-lg-7">
                                                    ...
                                                    <div class="pd-detail">
                                                        <div>
                                                            ...
                                                            <span class="pd-detail__name">{{ $shoplistproduct->product_name
                                                                }}</span>
                                                        </div>
                                                        <div>
        ...
        $discountPercentage = $actualPrice > 0
            ...
            $shoplistproduct->stock_quantity }} in stock</span>
                                                </div>
                                            </div>
                                            <div class="u-s-m-b-15">
            ...
            $shoplistproduct->product_name }}</span>
                                                                ...
                                                                <span class="success__price">{{ $shoplistproduct->sell_price
                                                                    }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
