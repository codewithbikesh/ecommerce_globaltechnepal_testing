...
<a href="{{ route('frontend.dashboard') }}">    <div class="fas fa-tachometer-alt" id="ecomNav-cart-btn"></div></a>
...
<form action="" class="ecomNav-login-form">
    <h3>Be Our Member</h3>
  <a href="{{ route('frontend.signin') }}" class="ecomNav-btn"> <button>Login</button></a> 
  <a href="{{ route('frontend.signup') }}" class="ecomNav-btn"> <button>I am New</button></a> 
</form>
   </div>   
<div class="">
